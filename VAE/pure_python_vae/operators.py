...
# standard convolution layer, point of method is to modify data specially before feeding to tensorflow.nn method
def conv2d(x, inputFeatures, outputFeatures, name):
    with tf.variable_scope(name):
        # create a variable from bits and pieces of another variable, with carefully curated initialializer. adds noise?
        ...
        # these are standard input parameters for convolutional neural networks
